...
nut_angle = 360/3,		// angle between nuts, standard = 90
nut_shaft_distance = 0.9,	// distance between inner face of nut and shaft, can be negative.
fnmult=4
)
{
  ...
  MXL_pulley_dia = tooth_spacing (2.032,0.254,teeth=teeth);
  40DP_pulley_dia = tooth_spacing (2.07264,0.1778,teeth=teeth);
  XL_pulley_dia = tooth_spacing (5.08,0.254,teeth=teeth);
  H_pulley_dia = tooth_spacing (9.525,0.381,teeth=teeth);
  T2_5_pulley_dia = tooth_spaceing_curvefit (0.7467,0.796,1.026,teeth=teeth);
  T5_pulley_dia = tooth_spaceing_curvefit (0.6523,1.591,1.064,teeth=teeth);
  T10_pulley_dia = tooth_spacing (10,0.93,teeth=teeth);
  AT5_pulley_dia = tooth_spaceing_curvefit (0.6523,1.591,1.064,teeth=teeth);
  HTD_3mm_pulley_dia = tooth_spacing (3,0.381,teeth=teeth);
  HTD_5mm_pulley_dia = tooth_spacing (5,0.5715,teeth=teeth);
  HTD_8mm_pulley_dia = tooth_spacing (8,0.6858,teeth=teeth);
  GT2_2mm_pulley_dia = tooth_spacing (2,0.254,teeth=teeth);
  GT2_3mm_pulley_dia = tooth_spacing (3,0.381,teeth=teeth);
  GT2_5mm_pulley_dia = tooth_spacing (5,0.5715,teeth=teeth);
    
  if ( profile == 1 ) { pulley ( "MXL" , MXL_pulley_dia , 0.508 , 1.321,     teeth=teeth, profile=profile, motor_shaft=motor_shaft, m3_dia=m3_dia, m3_nut_hex=m3_nut_hex, m3_nut_flats=m3_nut_flats, m3_nut_depth=m3_nut_depth, retainer=retainer, retainer_ht=retainer_ht, idler=idler, idler_ht=idler_ht, pulley_t_ht=pulley_t_ht, pulley_b_ht=pulley_b_ht, pulley_b_dia=pulley_b_dia, no_of_nuts=no_of_nuts, nut_angle=nut_angle, nut_shaft_distance=nut_shaft_distance, fnmult=fnmult ); }
  if ( profile == 2 ) { pulley ( "40 D.P." , 40DP_pulley_dia , 0.457 , 1.226,     teeth=teeth, profile=profile, motor_shaft=motor_shaft, m3_dia=m3_dia, m3_nut_hex=m3_nut_hex, m3_nut_flats=m3_nut_flats, m3_nut_depth=m3_nut_depth, retainer=retainer, retainer_ht=retainer_ht, idler=idler, idler_ht=idler_ht, pulley_t_ht=pulley_t_ht, pulley_b_ht=pulley_b_ht, pulley_b_dia=pulley_b_dia, no_of_nuts=no_of_nuts, nut_angle=nut_angle, nut_shaft_distance=nut_shaft_distance, fnmult=fnmult ); }
  if ( profile == 3 ) { pulley ( "XL" , XL_pulley_dia , 1.27, 3.051,     teeth=teeth, profile=profile, motor_shaft=motor_shaft, m3_dia=m3_dia, m3_nut_hex=m3_nut_hex, m3_nut_flats=m3_nut_flats, m3_nut_depth=m3_nut_depth, retainer=retainer, retainer_ht=retainer_ht, idler=idler, idler_ht=idler_ht, pulley_t_ht=pulley_t_ht, pulley_b_ht=pulley_b_ht, pulley_b_dia=pulley_b_dia, no_of_nuts=no_of_nuts, nut_angle=nut_angle, nut_shaft_distance=nut_shaft_distance, fnmult=fnmult ); }
  if ( profile == 4 ) { pulley ( "H" , H_pulley_dia ,1.905 , 5.359,     teeth=teeth, profile=profile, motor_shaft=motor_shaft, m3_dia=m3_dia, m3_nut_hex=m3_nut_hex, m3_nut_flats=m3_nut_flats, m3_nut_depth=m3_nut_depth, retainer=retainer, retainer_ht=retainer_ht, idler=idler, idler_ht=idler_ht, pulley_t_ht=pulley_t_ht, pulley_b_ht=pulley_b_ht, pulley_b_dia=pulley_b_dia, no_of_nuts=no_of_nuts, nut_angle=nut_angle, nut_shaft_distance=nut_shaft_distance, fnmult=fnmult ); }
  if ( profile == 5 ) { pulley ( "T2.5" , T2_5_pulley_dia , 0.7 , 1.678,     teeth=teeth, profile=profile, motor_shaft=motor_shaft, m3_dia=m3_dia, m3_nut_hex=m3_nut_hex, m3_nut_flats=m3_nut_flats, m3_nut_depth=m3_nut_depth, retainer=retainer, retainer_ht=retainer_ht, idler=idler, idler_ht=idler_ht, pulley_t_ht=pulley_t_ht, pulley_b_ht=pulley_b_ht, pulley_b_dia=pulley_b_dia, no_of_nuts=no_of_nuts, nut_angle=nut_angle, nut_shaft_distance=nut_shaft_distance, fnmult=fnmult ); }
  if ( profile == 6 ) { pulley ( "T5" , T5_pulley_dia , 1.19 , 3.264,     teeth=teeth, profile=profile, motor_shaft=motor_shaft, m3_dia=m3_dia, m3_nut_hex=m3_nut_hex, m3_nut_flats=m3_nut_flats, m3_nut_depth=m3_nut_depth, retainer=retainer, retainer_ht=retainer_ht, idler=idler, idler_ht=idler_ht, pulley_t_ht=pulley_t_ht, pulley_b_ht=pulley_b_ht, pulley_b_dia=pulley_b_dia, no_of_nuts=no_of_nuts, nut_angle=nut_angle, nut_shaft_distance=nut_shaft_distance, fnmult=fnmult ); }
  if ( profile == 7 ) { pulley ( "T10" , T10_pulley_dia , 2.5 , 6.13,     teeth=teeth, profile=profile, motor_shaft=motor_shaft, m3_dia=m3_dia, m3_nut_hex=m3_nut_hex, m3_nut_flats=m3_nut_flats, m3_nut_depth=m3_nut_depth, retainer=retainer, retainer_ht=retainer_ht, idler=idler, idler_ht=idler_ht, pulley_t_ht=pulley_t_ht, pulley_b_ht=pulley_b_ht, pulley_b_dia=pulley_b_dia, no_of_nuts=no_of_nuts, nut_angle=nut_angle, nut_shaft_distance=nut_shaft_distance, fnmult=fnmult ); }
  if ( profile == 8 ) { pulley ( "AT5" , AT5_pulley_dia , 1.19 , 4.268,     teeth=teeth, profile=profile, motor_shaft=motor_shaft, m3_dia=m3_dia, m3_nut_hex=m3_nut_hex, m3_nut_flats=m3_nut_flats, m3_nut_depth=m3_nut_depth, retainer=retainer, retainer_ht=retainer_ht, idler=idler, idler_ht=idler_ht, pulley_t_ht=pulley_t_ht, pulley_b_ht=pulley_b_ht, pulley_b_dia=pulley_b_dia, no_of_nuts=no_of_nuts, nut_angle=nut_angle, nut_shaft_distance=nut_shaft_distance, fnmult=fnmult ); }
  if ( profile == 9 ) { pulley ( "HTD 3mm" , HTD_3mm_pulley_dia , 1.289 , 2.27,     teeth=teeth, profile=profile, motor_shaft=motor_shaft, m3_dia=m3_dia, m3_nut_hex=m3_nut_hex, m3_nut_flats=m3_nut_flats, m3_nut_depth=m3_nut_depth, retainer=retainer, retainer_ht=retainer_ht, idler=idler, idler_ht=idler_ht, pulley_t_ht=pulley_t_ht, pulley_b_ht=pulley_b_ht, pulley_b_dia=pulley_b_dia, no_of_nuts=no_of_nuts, nut_angle=nut_angle, nut_shaft_distance=nut_shaft_distance, fnmult=fnmult ); }
  if ( profile == 10 ) { pulley ( "HTD 5mm" , HTD_5mm_pulley_dia , 2.199 , 3.781,     teeth=teeth, profile=profile, motor_shaft=motor_shaft, m3_dia=m3_dia, m3_nut_hex=m3_nut_hex, m3_nut_flats=m3_nut_flats, m3_nut_depth=m3_nut_depth, retainer=retainer, retainer_ht=retainer_ht, idler=idler, idler_ht=idler_ht, pulley_t_ht=pulley_t_ht, pulley_b_ht=pulley_b_ht, pulley_b_dia=pulley_b_dia, no_of_nuts=no_of_nuts, nut_angle=nut_angle, nut_shaft_distance=nut_shaft_distance, fnmult=fnmult ); }
  if ( profile == 11 ) { pulley ( "HTD 8mm" , HTD_8mm_pulley_dia , 3.607 , 6.603,     teeth=teeth, profile=profile, motor_shaft=motor_shaft, m3_dia=m3_dia, m3_nut_hex=m3_nut_hex, m3_nut_flats=m3_nut_flats, m3_nut_depth=m3_nut_depth, retainer=retainer, retainer_ht=retainer_ht, idler=idler, idler_ht=idler_ht, pulley_t_ht=pulley_t_ht, pulley_b_ht=pulley_b_ht, pulley_b_dia=pulley_b_dia, no_of_nuts=no_of_nuts, nut_angle=nut_angle, nut_shaft_distance=nut_shaft_distance, fnmult=fnmult ); }
  if ( profile == 12 ) { pulley ( "GT2 2mm" , GT2_2mm_pulley_dia , 0.764 , 1.494,     teeth=teeth, profile=profile, motor_shaft=motor_shaft, m3_dia=m3_dia, m3_nut_hex=m3_nut_hex, m3_nut_flats=m3_nut_flats, m3_nut_depth=m3_nut_depth, retainer=retainer, retainer_ht=retainer_ht, idler=idler, idler_ht=idler_ht, pulley_t_ht=pulley_t_ht, pulley_b_ht=pulley_b_ht, pulley_b_dia=pulley_b_dia, no_of_nuts=no_of_nuts, nut_angle=nut_angle, nut_shaft_distance=nut_shaft_distance, fnmult=fnmult ); }
  if ( profile == 13 ) { pulley ( "GT2 3mm" , GT2_3mm_pulley_dia , 1.169 , 2.31,     teeth=teeth, profile=profile, motor_shaft=motor_shaft, m3_dia=m3_dia, m3_nut_hex=m3_nut_hex, m3_nut_flats=m3_nut_flats, m3_nut_depth=m3_nut_depth, retainer=retainer, retainer_ht=retainer_ht, idler=idler, idler_ht=idler_ht, pulley_t_ht=pulley_t_ht, pulley_b_ht=pulley_b_ht, pulley_b_dia=pulley_b_dia, no_of_nuts=no_of_nuts, nut_angle=nut_angle, nut_shaft_distance=nut_shaft_distance, fnmult=fnmult ); }
  if ( profile == 14 ) { pulley ( "GT2 5mm" , GT2_5mm_pulley_dia , 1.969 , 3.952,     teeth=teeth, profile=profile, motor_shaft=motor_shaft, m3_dia=m3_dia, m3_nut_hex=m3_nut_hex, m3_nut_flats=m3_nut_flats, m3_nut_depth=m3_nut_depth, retainer=retainer, retainer_ht=retainer_ht, idler=idler, idler_ht=idler_ht, pulley_t_ht=pulley_t_ht, pulley_b_ht=pulley_b_ht, pulley_b_dia=pulley_b_dia, no_of_nuts=no_of_nuts, nut_angle=nut_angle, nut_shaft_distance=nut_shaft_distance, fnmult=fnmult ); }
}
...
teeth, profile, motor_shaft, m3_dia, m3_nut_hex, m3_nut_flats, m3_nut_depth, retainer, retainer_ht, idler, idler_ht, pulley_t_ht, pulley_b_ht, pulley_b_dia, no_of_nuts, nut_angle, nut_shaft_distance,
fnmult=4
 )
	{
    additional_tooth_width = 0.2; //mm
...
//	translate ([0,0, pulley_b_ht + pulley_t_ht + retainer_ht ]) rotate ([0,180,0])
	...
	difference()
	 {	 
        ...
        mirror([0,0,1])
				rotate_extrude($fn=is_undef($fast_preview) ? ceil(pulley_b_dia*fnmult) : 30)
				{
		...
		difference()
			...
			cylinder(r=pulley_OD/2,h=pulley_t_ht, $fn=is_undef($fast_preview) ? teeth*4 : 30);
	
			//teeth - cut out of shaft
		
      if (is_undef($HIDE_BELT_TEETH) && is_undef($fast_preview))
			for(i=[1:teeth]) 
			rotate([0,0,i*(360/teeth)])
			translate([0,-tooth_distance_from_centre,pulley_b_ht -1]) 
			scale ([ tooth_width_scale , tooth_depth_scale , 1 ]) 
			{
			if ( profile == 1 ) { MXL(pulley_t_ht=pulley_t_ht);}
			if ( profile == 2 ) { 40DP(pulley_t_ht=pulley_t_ht);}
			if ( profile == 3 ) { XL(pulley_t_ht=pulley_t_ht);}
			if ( profile == 4 ) { H(pulley_t_ht=pulley_t_ht);}
			if ( profile == 5 ) { T2_5(pulley_t_ht=pulley_t_ht);}
			if ( profile == 6 ) { T5(pulley_t_ht=pulley_t_ht);}
			if ( profile == 7 ) { T10(pulley_t_ht=pulley_t_ht);}
			if ( profile == 8 ) { AT5(pulley_t_ht=pulley_t_ht);}
			if ( profile == 9 ) { HTD_3mm(pulley_t_ht=pulley_t_ht);}
			if ( profile == 10 ) { HTD_5mm(pulley_t_ht=pulley_t_ht);}
			if ( profile == 11 ) { HTD_8mm(pulley_t_ht=pulley_t_ht);}
			if ( profile == 12 ) { GT2_2mm(pulley_t_ht=pulley_t_ht);}
			if ( profile == 13 ) { GT2_3mm(pulley_t_ht=pulley_t_ht);}
			if ( profile == 14 ) { GT2_5mm(pulley_t_ht=pulley_t_ht);}
			}
		...
		rotate_extrude($fn=is_undef($fast_preview) ? teeth*4 : 30)  
    ...
    if (motor_shaft > 0)
		translate([0,0,-1])
    cylinder(r=motor_shaft/2,h=pulley_b_ht + pulley_t_ht + retainer_ht + 2,$fn=is_undef($fast_preview) ? ceil(motor_shaft*fnmult) : 20);
    ...
    //else
    {
		//if ( (pulley_b_dia - motor_shaft)/2 < m3_nut_depth + 3 ) { echo ("CAN'T DRAW CAPTIVE NUTS, DIAMETER TOO SMALL FOR NUT DEPTH!!!"); }
    //else
    {
